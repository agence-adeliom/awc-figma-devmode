...
const transforms = jsdoc2md.renderSync({
  ...
  template: fs
    .readFileSync("scripts/handlebars/templates/transforms.hbs")
    .toString(),
  "no-gfm": true,
  separators: true,
...
const transform_groups = jsdoc2md.renderSync({
  ...
  template: fs
    .readFileSync("scripts/handlebars/templates/transform_groups.hbs")
    .toString(),
  "no-gfm": true,
  separators: true,
  partial: ["scripts/handlebars/header.hbs", "scripts/handlebars/body.hbs"],
...
const actions = jsdoc2md.renderSync({
  ...
  template: fs
    .readFileSync("scripts/handlebars/templates/actions.hbs")
    .toString(),
  "no-gfm": true,
  separators: true,
  partial: ["scripts/handlebars/header.hbs", "scripts/handlebars/body.hbs"],
...
const formats = jsdoc2md.renderSync({
  files: [
    ...
    "lib/common/formatHelpers/*.js",
  ],
  template: fs
    .readFileSync("scripts/handlebars/templates/formats.hbs")
    .toString(),
  "no-gfm": true,
  separators: true,
  partial: ["scripts/handlebars/header.hbs", "scripts/handlebars/body.hbs"],
