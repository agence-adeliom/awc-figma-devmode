 ...
 * th.mjsicense. A copy of the License is located at
 *
 * http://www.apache.org/licenses/LICENSE-2.0
 *
 * or in the "license" file accompanying this file. This file is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR
 * CONDITIONS OF ANY KIND, eith.mjsexpress or implied. See the License for the specific language governing permissions
...
const cssFonts = require('./templates/css/fonts.css.template.js');
const macrosTemplate = require('./templates/ios/macros.template.js');
const plistTemplate = require('./templates/ios/plist.template.js');
const mapFlatTemplate = require("./templates/scss/map-flat.template.js");
const mapDeepTemplate = require("./templates/scss/map-deep.template.js");
const resourcesTemplate = require("./templates/android/resources.template.js");
const colorsTemplate = require("./templates/android/colors.template.js");
const dimensTemplate = require("./templates/android/dimens.template.js");
const fontDimensTemplate = require("./templates/android/fontDimens.template.js");
const integersTemplate = require("./templates/android/integers.template.js");
const stringsTemplate = require("./templates/android/strings.template.js");
const objectKtTemplate = require("./templates/compose/object.kt.template.js");
const singletonMTemplate = require("./templates/ios/singleton.m.template.js");
const singletonHTemplate = require("./templates/ios/singleton.h.template.js");
const staticHTemplate = require("./templates/ios/static.h.template.js");
const staticMTemplate = require("./templates/ios/static.m.template.js");
const colorsHTemplate = require("./templates/ios/colors.h.template.js");
const colorsMTemplate = require("./templates/ios/colors.m.template.js");
const stringsHTemplate = require("./templates/ios/strings.h.template.js");
const stringsMTemplate = require("./templates/ios/strings.m.template.js");
const anySwiftTemplate = require("./templates/ios-swift/any.swift.template.js");
const classDartTemplate = require("./templates/flutter/class.dart.template.js");
...
module.exports = {
  ...
  "scss/map-flat": function ({ dictionary, options, file }) {
    const template = _template(mapFlatTemplate);
  ...
  "scss/map-deep": function ({ dictionary, options, file }) {
    const mapTemplate = _template(mapDeepTemplate);
      ...
      dictionary.allProperties
        .map(function (prop) {
          ...
          to_ret_prop +=
            ...
            prop.name +
            " : " +
            getTypeScriptType(prop.value, options) +
            ";";
          return to_ret_prop;
        })
        .join("\n") +
...
declare const ${moduleName}: ${JSON.stringify(treeWalker(dictionary.tokens), null, 2)}`;
  ...
  "android/resources": function ({ dictionary, options, file }) {
    const template = _template(resourcesTemplate);
  ...
  "android/colors": function ({ dictionary, options, file }) {
    const template = _template(colorsTemplate);
    return template({ dictionary, file, options, fileHeader });
  },
  ...
  "android/dimens": function ({ dictionary, options, file }) {
    const template = _template(dimensTemplate);
    return template({ dictionary, file, options, fileHeader });
  },
  ...
  "android/fontDimens": function ({ dictionary, options, file }) {
    const template = _template(fontDimensTemplate);
    return template({ dictionary, file, options, fileHeader });
  },
  ...
  "android/integers": function ({ dictionary, options, file }) {
    const template = _template(integersTemplate);
    return template({ dictionary, file, options, fileHeader });
  },
  ...
  "android/strings": function ({ dictionary, options, file }) {
    const template = _template(stringsTemplate);
    return template({ dictionary, file, options, fileHeader });
  },
  ...
  "compose/object": function ({ dictionary, options, file }) {
    const template = _template(objectKtTemplate);
    let allProperties;
    const { outputReferences } = options;
  ...
  "ios/macros": function ({ dictionary, options, file }) {
    const template = _template(macrosTemplate);
  ...
  "ios/plist": function ({ dictionary, options, file }) {
    const template = _template(plistTemplate);
  ...
  "ios/singleton.m": function ({ dictionary, options, file }) {
    const template = _template(singletonMTemplate);
  ...
  "ios/singleton.h": function ({ dictionary, options, file }) {
    const template = _template(singletonHTemplate);
  ...
  "ios/static.h": function ({ dictionary, options, file }) {
    const template = _template(staticHTemplate);
  ...
  "ios/static.m": function ({ dictionary, options, file }) {
    const template = _template(staticMTemplate);
  ...
  "ios/colors.h": function ({ dictionary, options, file }) {
    const template = _template(colorsHTemplate);
  ...
  "ios/colors.m": function ({ dictionary, options, file }) {
    const template = _template(colorsMTemplate);
  ...
  "ios/strings.h": function ({ dictionary, options, file }) {
    const template = _template(stringsHTemplate);
  ...
  "ios/strings.m": function ({ dictionary, options, file }) {
    const template = _template(stringsMTemplate);
    return template({ dictionary, options, file, fileHeader });
  },
  ...
  "ios-swift/class.swift": function ({ dictionary, options, file, platform }) {
    const template = _template(anySwiftTemplate);
    let allTokens;
    const { outputReferences } = options;
   ...
   * @todo Add example and usage
   */
  "css/fonts.css": _template(cssFonts),
  ...
  "flutter/class.dart": function ({ dictionary, options, file }) {
    const template = _template(classDartTemplate);
    let allTokens;
    const { outputReferences } = options;
    const formatProperty = createPropertyFormatter({
      outputReferences,
