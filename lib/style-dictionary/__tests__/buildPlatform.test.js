...
var StyleDictionaryExtended = StyleDictionary.extend(helpers.getBaseConfig());
...
describe("buildPlatform", () => {
  ...
  it("should build web platform files", () => {
    ...
    expect(
      fs.get("/__tests__/__output/web/_styles.js")
    ).toBeTruthy();
    expect(
      fs.get("/__tests__/__output/web/_variables.css")
    ).toBeTruthy();
  });
  ...
  it("should build scss platform files", () => {
    ...
    expect(
      fs.get("/__tests__/__output/scss/_icons.scss")
    ).toBeTruthy();
    expect(
      fs.get("/__tests__/__output/scss/_variables.scss")
    ).toBeTruthy();
  });
  ...
  it("should build less platform files", () => {
    ...
    expect(
      fs.get("/__tests__/__output/less/_icons.less")
    ).toBeTruthy();
    expect(
      fs.get("/__tests__/__output/less/_variables.less")
    ).toBeTruthy();
  });
  ...
  it("should do android stuff", () => {
    ...
    expect(
      fs.get("/__tests__/__output/android/dimens.xml")
    ).toBeTruthy();
    expect(
      fs.get("/__tests__/__output/android/font_dimen.xml")
    ).toBeTruthy();
  });
  ...
  it("should do ios stuff", () => {
    ...
    expect(
      fs.get("/__tests__/__output/ios/style_dictionary.plist")
    ).toBeTruthy();
    expect(
      fs.get("/__tests__/__output/ios/style_dictionary.h")
    ).toBeTruthy();
  });

  it("should handle non-string values in properties", () => {
    var StyleDictionaryExtended = StyleDictionary.extend({
      source: helpers.getTokens(["./__tests__/__properties/nonString.json"]),
      platforms: {
        test: {
    ...
    expect(output.object.test.value).toMatchObject(
      output.object.otherTest.value
    );
  ...
  it("should handle non-property nodes", () => {
    var StyleDictionaryExtended = StyleDictionary.extend({
      source: helpers.getTokens([ "./__tests__/__properties/nonPropertyNode.json"]),
      platforms: {
        test: {
          buildPath: "/__tests__/__output/",
          transformGroup: "scss",
    ...
    expect(output.color.base.attributes.key3).toEqual(
      input.color.base.attributes.key3
    );
  });

  it("should handle comments", () => {
    var StyleDictionaryExtended = StyleDictionary.extend({
      source: helpers.getTokens(["./__tests__/__properties/comment.json"]),
      platforms: {
        test: {
          buildPath: "/__tests__/__output/",
          transformGroup: "scss",
  ...
  it("should throw an error if given a transformGroup that doesn't exist", () => {
    var StyleDictionaryExtended = StyleDictionary.extend({
      source: helpers.getTokens(["./__tests__/__properties/**/*.json"]),
      platforms: {
        foo: {
          transformGroup: "bar",
          files: [
