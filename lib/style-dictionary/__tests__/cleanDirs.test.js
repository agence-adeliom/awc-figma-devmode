...
var platform = {
  files: [
    {
      destination:
        "/__tests__/__output/extradir1/extradir2/extradir1/extradir2/test.json",
...
describe("cleanDirs", () => {
  ...
  it("should delete without buildPath", () => {
    ...
    expect(
      helpers.dirDoesNotExist("/__tests__/__output/extradir1/extradir2")
    ).toBeTruthy();
    expect(
      helpers.dirDoesNotExist("/__tests__/__output/extradir1")
    ).toBeTruthy();
  });
