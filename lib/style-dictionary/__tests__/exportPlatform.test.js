...
const styleDictionary = StyleDictionary.extend(helpers.getBaseConfig());
...
describe("exportPlatform", () => {
  ...
  it("should have the same structure as the original properties", () => {
    ...
    expect(Object.keys(dictionary)).toEqual(
      Object.keys(styleDictionary.properties)
    );
  });

  it("should have resolved references", () => {
    var dictionary = styleDictionary.exportPlatform("web");
    expect(dictionary.color.font.link.value).toEqual(
  ...
  it("should have applied transforms for props with refs in it", () => {
    ...
    expect(dictionary.color.button.hover.value).toEqual(
      "#0077CC-darker-darker"
    );
  });
  ...
  it("should not have mutated the original properties", () => {
    var dictionary = styleDictionary.exportPlatform("web");
    expect(dictionary.color.font.link.value).not.toEqual(
  ...
  it("properties should have original value untouched", () => {
    var dictionary = styleDictionary.exportPlatform("web");
    var properties = helpers.fileToJSON("./__tests__/__properties/colors.json");
    expect(dictionary.color.font.link.original.value).toEqual(
