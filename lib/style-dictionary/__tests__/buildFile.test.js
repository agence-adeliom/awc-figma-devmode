...
describe("buildFile", () => {
  ...
  it("should error if format doesnt exist or isnt a function", () => {
    expect(
      buildFile.bind(
        null,
        { destination: "/__tests__/__output/test.txt" },
        {},
        {}
      )
    ...
    expect(
      buildFile.bind(
        null,
        { destination: "/__tests__/__output/test.txt", format: {} },
        {},
        {}
      )
    ).toThrow("Please enter a valid file format");
  ...
  it("should error if destination doesnt exist or isnt a string", () => {
    expect(buildFile.bind(null, { format }, {}, {})).toThrow(
      "Please enter a valid destination"
    );
    expect(buildFile.bind(null, { format, destination: [] }, {}, {})).toThrow(
      "Please enter a valid destination"
    );
    expect(buildFile.bind(null, { format, destination: {} }, {}, {})).toThrow(
      "Please enter a valid destination"
  ...
  describe("name collisions", () => {
    ...
    it("should generate warning messages for output name collisions", () => {
      ...
      let collisions = properties.allProperties
        .map((properties) => {
          return `${properties.path.join(".")}   ${properties.value}`;
        })
        .join("\n        ");
      let output = `Output name '${name}' was generated by:\n        ${collisions}`;
    ...
    it("should not warn users if the format is a nested format", () => {
      ...
      expect(console.log).toHaveBeenCalledWith(`✔︎ ${destination}`);
    });
  });
  ...
  it("should warn when a file is not created because of empty properties", () => {
    ...
    expect(
      fs.get("/__tests__/__output/test.emptyProperties")
    ).toBeFalsy();
  });
  ...
  it("should write to a file properly", () => {
    ...
    expect(fs.get("/__tests__/__output/test.txt")).toBeTruthy();
  });
});
