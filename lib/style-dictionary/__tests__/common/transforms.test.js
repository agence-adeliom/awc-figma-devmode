  ...
  describe("transforms", () => {
    ...
    describe("transform", () => {
      describe("attribute/cti", () => {
        ...
        const attrsOverride =
          transforms["attribute/cti"].transformer(propOverride);
    ...
    describe("color/ColorSwiftUI", () => {
      it("should handle normal colors", () => {
        ...
        expect(value).toBe(
          "Color(red: 0.667, green: 0.667, blue: 0.667, opacity: 1)"
        );
      });
      ...
      it("should retain enough precision when converting to decimal", () => {
        ...
        expect(value).toBe(
          "Color(red: 0.114, green: 0.114, blue: 0.114, opacity: 1)"
        );
      });
    ...
    describe("size/sp", () => {
      ...
      it("should throw an error if prop value is Nan", () => {
        expect(() =>
          transforms["size/sp"].transformer({ value: "a" })
        ).toThrow();
      });
    });
    ...
    describe("size/dp", () => {
      ...
      it("should throw an error if prop value is Nan", () => {
        expect(() =>
          transforms["size/dp"].transformer({ value: "a" })
        ).toThrow();
      });
    });
    ...
    describe("size/object", () => {
      ...
      it("should throw an error if prop value is NaN", () => {
        expect(() =>
          transforms["size/object"].transformer({ value: "a" })
        ).toThrow();
      });
    });
    ...
    describe("size/compose/em", () => {
      ...
      it("should throw an error if prop value is Nan", () => {
        expect(() =>
          transforms["size/compose/em"].transformer({ value: "a" })
        ).toThrow();
      });
    });
    ...
    describe("size/pxToRem", () => {
      ...
      it("converts pixel to rem using custom base font", () => {
        expect(
          pxToRemTransformer({ value: "14px" }, { basePxFontSize: 14 })
        ).toBe("1rem");
      });
