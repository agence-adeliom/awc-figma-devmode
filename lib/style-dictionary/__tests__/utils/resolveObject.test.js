...
describe("utils", () => {
  describe("resolveObject", () => {
    it("should error on non-objects", () => {
      ...
      expect(resolveObject.bind(null, "foo")).toThrow(
    ...
    it("should do simple references", () => {
      var test = resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/simple.json")
      );
    ...
    it("should do simple interpolation for both strings and numbers", () => {
      var test = resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/interpolation.json")
      );
    ...
    it("should handle nested pointers", () => {
      var test = resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/nested_pointers.json")
      );
    ...
    it("should handle deep nested pointers", () => {
      var test = resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/nested_pointers_2.json")
      );
    ...
    it("should handle deep nested pointers with string interpolation", () => {
      var test = resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/nested_pointers_3.json")
      );
    ...
    it("should handle deep nested pointers and nested references", () => {
      var test = resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/nested_pointers_4.json")
      );
    ...
    it("should keep the type of the referenced property", () => {
      var test = resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/reference_type.json")
      );
      expect(test).toHaveProperty("d", 1);
    ...
    it("should handle and evaluate items in an array", () => {
      var test = resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/array.json")
      );
    ...
    it("should throw if pointers don't exist", () => {
      expect(
        resolveObject.bind(
          helpers.fileToJSON("./__tests__/__json_files/non_existent.json")
        )
      ).toThrow();
    });
    ...
    it("should gracefully handle basic circular references", () => {
      ...
      resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/circular.json")
      );
    ...
    it("should gracefully handle basic and nested circular references", () => {
      ...
      resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/circular_2.json")
      );
      expect(GroupMessages.count(PROPERTY_REFERENCE_WARNINGS)).toBe(1);
      expect(
        JSON.stringify(GroupMessages.fetchMessages(PROPERTY_REFERENCE_WARNINGS))
    ...
    it("should gracefully handle nested circular references", () => {
      ...
      resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/circular_3.json")
      );
      expect(GroupMessages.count(PROPERTY_REFERENCE_WARNINGS)).toBe(1);
      expect(
        JSON.stringify(GroupMessages.fetchMessages(PROPERTY_REFERENCE_WARNINGS))
    ...
    it("should gracefully handle multiple nested circular references", () => {
      ...
      resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/circular_4.json")
      );
      expect(GroupMessages.count(PROPERTY_REFERENCE_WARNINGS)).toBe(1);
      expect(
        JSON.stringify(GroupMessages.fetchMessages(PROPERTY_REFERENCE_WARNINGS))
    ...
    it("should gracefully handle down-chain circular references", () => {
      ...
      resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/circular_5.json")
      );
      expect(GroupMessages.count(PROPERTY_REFERENCE_WARNINGS)).toBe(1);
      expect(
        JSON.stringify(GroupMessages.fetchMessages(PROPERTY_REFERENCE_WARNINGS))
    ...
    it("should correctly replace multiple references without reference errors", function () {
      ...
      var obj = resolveObject(
        helpers.fileToJSON("./__tests__/__json_files/not_circular.json")
      );
    ...
    it("should collect multiple reference errors", () => {
      ...
      resolveObject(
        helpers.fileToJSON(
          "./__tests__/__json_files/multiple_reference_errors.json"
        )
      );
