...
describe("formats", function () {
  describe("json/nested", function () {
    ...
    it("should be a valid JSON file", function () {
      ...
      const test = fs.getJSON("/__tests__/__output/json-nested.json");
    ...
    it("should handle non-token data", function () {
      ...
      const test = fs.getJSON("/__tests__/__output/json-nested.json");
      expect(test.color.base.comment).toEqual(
        dictionary.properties.color.base.comment
      );
      expect(test.color.base.metadata).toEqual(
        dictionary.properties.color.base.metadata
      );
    });
  });
});
