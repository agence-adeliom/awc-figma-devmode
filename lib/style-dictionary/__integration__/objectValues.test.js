...
describe("integration", () => {
  describe("object values", () => {
    ...
    describe("css/variables", () => {
      describe(`hsl syntax`, () => {
        const output = fs.get(`${buildPath}hsl.css`);
        it(`should match snapshot`, () => {
          expect(output).toMatchSnapshot();
        });

        describe(`with references`, () => {
          const output = fs.get(`${buildPath}hslWithReferences.css`);
          it(`should match snapshot`, () => {
            expect(output).toMatchSnapshot();
          });
        });
      ...
      describe(`hex syntax`, () => {
        const output = fs.get(`${buildPath}hex.css`);
        it(`should match snapshot`, () => {
          expect(output).toMatchSnapshot();
        });

        describe(`with references`, () => {
          const output = fs.get(`${buildPath}hexWithReferences.css`);
          it(`should match snapshot`, () => {
            expect(output).toMatchSnapshot();
          });
        });
      ...
      describe(`border`, () => {
        const output = fs.get(`${buildPath}border.css`);
        it(`should match snapshot`, () => {
          expect(output).toMatchSnapshot();
        });

        describe(`with references`, () => {
          const output = fs.get(`${buildPath}borderWithReferences.css`);
          it(`should match snapshot`, () => {
            expect(output).toMatchSnapshot();
          });
        });
      ...
      describe("shadow", () => {
        it(`should match snapshot`, () => {
          const output = fs.get(`${buildPath}shadow.css`);
          expect(output).toMatchSnapshot();
        });

        it(`should match snapshot with references`, () => {
          const output = fs.get(`${buildPath}shadowWithReferences.css`);
          expect(output).toMatchSnapshot();
        });
      });
    });
    ...
    describe("scss/variables", () => {
      const output = fs.get(`${buildPath}border.scss`);
      it(`should match snapshot`, () => {
        expect(output).toMatchSnapshot();
      });

      describe(`with references`, () => {
        const output = fs.get(`${buildPath}borderWithReferences.scss`);
        it(`should match snapshot`, () => {
          expect(output).toMatchSnapshot();
        });
      });
