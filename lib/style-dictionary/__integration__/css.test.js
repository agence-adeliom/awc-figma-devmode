...
describe("integration", () => {
  describe("css", () => {
    ...
    describe("css/variables", () => {
      const output = fs.get(`${buildPath}variables.css`);
      it(`should match snapshot`, () => {
        expect(output).toMatchSnapshot();
      });

      describe(`with references`, () => {
        const output = fs.get(`${buildPath}variablesWithReferences.css`);
        it(`should match snapshot`, () => {
          expect(output).toMatchSnapshot();
        });
      });
      ...
      describe(`with selector`, () => {
        const output = fs.get(`${buildPath}variablesWithSelector.css`);
        it(`should match snapshot`, () => {
          expect(output).toMatchSnapshot();
        });
      });
