...
describe("integration", () => {
  describe("custom formats", () => {
    ...
    describe(`inline custom with old args`, () => {
      const output = fs.get(`${buildPath}inlineCustomFormatWithOldArgs.json`);
      ...
      it(`should receive proper arguments`, () => {
        ...
        expect(platform).toHaveProperty(
          `options.otherOption`,
          `platform option`
        );
    ...
    describe(`inline custom with new args`, () => {
      const output = fs.get(`${buildPath}inlineCustomFormatWithNewArgs.json`);
      it(`should match snapshot`, () => {
        expect(output).toMatchSnapshot();
      });
    ...
    describe(`register custom format with old args`, () => {
      const output = fs.get(`${buildPath}registerCustomFormatWithOldArgs.json`);
    ...
    describe(`register custom format with new args`, () => {
      const output = fs.get(`${buildPath}registerCustomFormatWithNewArgs.json`);
