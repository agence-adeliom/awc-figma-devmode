import { rgbaObjectToColor } from '../utils/convertColor'
import { internalTokenInterface, StandardTokenInterface, StandardTokenTypes, StandardTokenDataInterface, StandardTokenGroup} from '../types'
...
const colorValueTransformer = ({ fill }): StandardTokenDataInterface => ({
  ...
  value: rgbaObjectToColor(fill.value),
...
const borderValueTransformer = ({ values }): StandardTokenDataInterface => ({
  ...
  value: {
    ...
    color: rgbaObjectToColor(values.stroke.value)
  }
})
...
const shadowValueTransformer = (value): StandardTokenDataInterface => ({
  ...
  value: {
    ...
    color: rgbaObjectToColor(value.color.value),
...
const transformVariable = ({ values, category }): StandardTokenDataInterface => {
  ...
  if (category === 'color') {
    return {
      type: 'color' as StandardTokenTypes,
      value: rgbaObjectToColor(values.fill.value),
