import { internalTokenInterface, tokenCategoryTypes, PropertyType, UnitTypePixel, OriginalFormatTokenInterface } from '../types'
import { convertRgbaObjectToString } from '../utils/convertColor'
import config from '../utils/config'

const sizeValueTransformer = ({ width }: { width: OriginalFormatTokenInterface}) => ({
  value: width.value,
  type: width.type,
